  ...
  return (
    <section id="experience" className="py-20 relative z-10 bg-gradient-to-b from-[#1a0d2e]/50 to-transparent">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {experiences.map((exp, index) => (
            <div key={index} className={`relative mb-16 md:mb-20 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
              ...
              <div className={`ml-16 md:ml-0 md:w-1/2 ${index % 2 === 1 ? 'md:ml-auto' : ''}`}>
                <div 
                  className="group bg-gradient-to-br from-[#1a0d2e]/80 to-[#2d1b4e]/80 p-8 rounded-xl border border-[#8b5cf6]/30 backdrop-blur-sm transform-gpu hover:scale-105 transition-all duration-500 card-3d neon-border hover:neon-glow cursor-pointer slide-in-up"
                ...
                >
                  ...
                  <h4 className="text-lg font-semibold text-[#8b5cf6] mb-3 group-hover:text-[#c084fc] transition-colors duration-300">
                    {exp.company}
                  </h4>
                  
                  {/* Location */}
                  <div className="flex items-center mb-6 text-gray-400 group-hover:text-gray-300 transition-colors duration-300">
                  ...
                  <div className="space-y-3">
                    {exp.responsibilities.map((resp, respIndex) => (
                      <div key={respIndex} className="flex items-start group/item hover:scale-105 transition-transform duration-200">
                        <Zap className="w-4 h-4 text-[#8b5cf6] mr-3 mt-1 flex-shrink-0 group-hover/item:text-[#e879f9] transition-colors duration-300" />
        ...
        {/* Education Section */}
        <div className="mt-20">
          <h3 className="text-3xl font-bold text-center mb-12 bg-gradient-to-r from-[#8b5cf6] to-[#e879f9] bg-clip-text text-transparent neon-text">
